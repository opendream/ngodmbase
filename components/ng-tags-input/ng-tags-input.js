...
/*!
 * Custom: To support Thai KEYBOARD
 * by KoYoYo
 *
 */
(function() {
...
tagsInput.directive('tagsInput', ["$timeout","$document","tagsInputConfig","tiUtil", function($timeout, $document, tagsInputConfig, tiUtil) {
    ...
    return {
        ...
        link: function(scope, element, attrs, ngModelCtrl) {
            //Remove Check Comma FOR THAI
            //var hotkeys = [KEYS.enter, KEYS.comma, KEYS.space, KEYS.backspace],
            var hotkeys = [KEYS.enter, KEYS.space, KEYS.backspace],
            ...
            events
                ...
                .on('input-keydown', function(event) {
                    ...
                    if ((isModifier || hotkeys.indexOf(key) === -1) && (options.addOnComma && event.originalEvent.keyIdentifier != KEYS.comma)) {
                        return;
                    }
                    ...
                    shouldAdd = (!options.addFromAutocompleteOnly && addKeys[key]) || (options.addOnComma && event.originalEvent.keyIdentifier == KEYS.comma);
